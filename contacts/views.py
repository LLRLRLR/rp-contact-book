...
class Window(QMainWindow):
    ...
    def setupUI(self):
        ...
        #Create the table view widget, QTableView to provide the table-like view that displays the contacts list
...
class AddDialog(QDialog):
    ...
    def setupUI(self):
        ...
        def accept(self):
            ...
            #calls the superclass’s .accept() slot to provide the standard behavior that closes the dialog after the user clicks OK.
            super().accept()